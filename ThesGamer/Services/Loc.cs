...
public static class Loc
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Map = new()
    {
        ["ru"] = new()
        {
            ...
            ["update_applying"] = "Обновление скачано. Перезапуск…",
            ["update_now"] = "Обновить сейчас?",
            ["auto_update"] = "Автообновление с GitHub",
            ["install_hint"] = "Установщик: ThesGamer-Setup.exe",
            ["na"] = "н/д",
            ["before"] = "До",
            ["after"] = "После",
            ["freed"] = "Освобождено",
        ...
        ["en"] = new()
        {
            ...
            ["update_applying"] = "Update downloaded. Restarting…",
            ["update_now"] = "Update now?",
            ["auto_update"] = "Auto-update from GitHub",
            ["install_hint"] = "Installer: ThesGamer-Setup.exe",
            ["na"] = "n/a",
            ["before"] = "Before",
            ["after"] = "After",
            ["freed"] = "Freed",
